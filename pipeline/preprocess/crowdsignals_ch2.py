...
for milliseconds_per_instance in granularities:
    ...
    DataSet.add_numerical_dataset('EMG_data.csv', 'timestamps', ['a', 'b', 'c', 'd', 'e', 'g', 'h', 'i'], 'avg', 'EMG_')
    ...
    DataSet.add_event_dataset('labels_EMG.csv', 'label_start', 'label_end', 'label', 'binary')
    ...
    # Plot all data
    DataViz.plot_dataset(dataset, ['EMG_', 'label'], ['like','like'], ['line', 'line', 'line', 'line'])
...
# util.print_latex_table_statistics_two_datasets(datasets[0])
